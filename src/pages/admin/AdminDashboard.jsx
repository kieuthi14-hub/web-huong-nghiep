...
const VISEF_SEED_COUNSELING = [
  {
    ...
    counselor_id: '33333333-3333-3333-3333-333333333333',
    counselor_name: 'Anh Trần Minh Triết - SV CNTT ĐH Bách Khoa',
    scheduled_at: '2026-02-25T14:30:00Z',
    status: 'pending',
    student_notes: '[Chuyên gia/Mentor: Anh Trần Minh Triết - SV CNTT ĐH Bách Khoa]\nEm muốn nhờ anh tư vấn kỹ hơn về môi trường học thực tế ngành Kỹ thuật Máy tính và AI tại Bách Khoa ạ.',
  ...
  },
  {
    ...
    counselor_name: 'Thầy Nguyễn Văn Minh - Cố vấn Hướng nghiệp',
    scheduled_at: '2026-02-26T09:00:00Z',
    status: 'confirmed',
    student_notes: '[Chuyên gia/Mentor: Thầy Nguyễn Văn Minh - Cố vấn Hướng nghiệp]\nNhờ Thầy tư vấn đánh giá phương thức xét tuyển sớm bằng học bạ và thi ĐGNL ĐHQG.',
  ...
  },
  {
    ...
    counselor_id: '44444444-4444-4444-4444-444444444444',
    counselor_name: 'Chị Nguyễn Hà Phương - SV Sư phạm Tiếng Anh',
    scheduled_at: '2026-02-27T16:00:00Z',
    status: 'pending',
    student_notes: '[Chuyên gia/Mentor: Chị Nguyễn Hà Phương - SV Sư phạm Tiếng Anh]\nEm muốn tìm hiểu lộ trình thi chứng chỉ IELTS và cơ hội việc làm ngành Biên dịch tiếng Anh.',
